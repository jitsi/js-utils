 ...
 */
const _PLURALNOUN_ = [
    "Abilities", "Absences", "Abundances", "Abuses", "Academics",
    ...
    "Aids", "Aids", "Aims", "Aircraft", "Airlines", "Airports", "Airs",
    "Alarms", "Albums", "Alcohols", "Alerts", "Aliens", "Alignments",
    ...
    "Borders", "Bosses", "Bottles", "Bottoms", "Boundaries", "Bowls",
    "Bows", "Boxes", "Boyfriends", "Boys", "Brains", "Branches", "Brands",
    "Breaches", "Breads", "Breakdowns", "Breakfasts", "Breaks",
    "Breakthroughs", "Breasts", "Breathings", "Breaths", "Breeds",
    "Brethren", "Bricks", "Brides", "Bridges", "Broadbands", "Broadcasters",
    "Broadcasts", "Browns", "Browsers", "Brushes", "Bubbles", "Bucks",
    ...
    "Canals", "Cancers", "Candidates", "Candles", "Cans", "Canvas",
    ...
    "Cases", "Cashes", "Casinos", "Castles", "Casts", "Casualties",
    ...
    "Crews", "Cries", "Crimes", "Criminals", "Crises", "Criteria",
    ...
    "Curricula", "Curtains", "Curves", "Custodies", "Customers", "Customs",
    ...
    "Deadlines", "Dealers", "Deals", "Deaths", "Debates", "Debris", "Debts",
    "Debuts", "Decades", "Decembers", "Decision-Makings", "Decisions",
    ...
    "Disappointments", "Disasters", "Disciplines", "Disclosures",
    "Discounts", "Discourses", "Discoveries", "Discretions",
    "Discriminations", "Discs", "Discussions", "Diseases", "Dishes",
    ...
    "Droughts", "Drugs", "Drums", "Duos", "Durations", "Dusts", "Duties",
    ...
    "Exclusions", "Excuses", "Executions", "Executives", "Exercises",
    ...
    "Extras", "Extremes", "Extremists", "Eyes", "Fabrics", "Faces",
    ...
    "Feelings", "Feels", "Fees", "Feet", "Females", "Feminists", "Fences",
    "Festivals", "Fevers", "Fibres", "Fictions", "Fields", "Fightings",
    "Fights", "Figures", "Files", "Film-Makers", "Films", "Filters",
    "Finals", "Finances", "Findings", "Fines", "Fingers", "Finishes",
    "Firearms", "Firefighters", "Fires", "Fireworks", "Firms", "Firsts",
    ...
    "Gamings", "Gangs", "Gaps", "Garages", "Gardens", "Gases", "Gates",
    "Gatherings", "Gazes", "Gears", "Genders", "Generations", "Genes",
    "Genius", "Genocides", "Genres", "Gentlemen", "Geographies", "Gestures",
    ...
    "Hospitals", "Hostages", "Hostilities", "Hosts", "Hotels", "Hours",
    ...
    "Identifications", "Identities", "Ideologies", "Idiots", "Ids",
    "Ignorances", "Illnesses", "Illusions", "Illustrations", "Imageries",
    "Images", "Imaginations", "Immigrants", "Immigrations", "Impacts",
    ...
    "Infants", "Infections", "Inflations", "Influences", "Information",
    "Infos", "Infrastructures", "Ingredients", "Inhabitants", "Initiatives",
    "Injections", "Injuries", "Injustices", "Inks", "Inmates",
    ...
    "Leaves", "Lectures", "Lefts", "Legacies", "Legends", "Legislation",
    ...
    "Limits", "Line-Ups", "Lines", "Links", "Lions", "Lips", "Liquids",
    ...
    "Majorities", "Make-Ups", "Makes", "Makings", "Males", "Malls",
    ...
    "Markets", "Marks", "Marriages", "Masks", "Massacres", "Masses",
    ...
    "Memoirs", "Memorials", "Memories", "Memos", "Men", "Mentions",
    ...
    "Miles", "Militants", "Militaries", "Militias", "Milks", "Mills",
    "Minds", "Minerals", "Miners", "Mines", "Minimums", "Minings",
    "Ministers", "Ministries", "Minorities", "Minutes", "Miracles",
    "Mirrors", "Miseries", "Missiles", "Missions", "Mistakes", "Mixes",
    "Mixtures", "Mobiles", "Mobilities", "Mobs", "Models", "Modes",
    ...
    "Mosques", "Mothers", "Motions", "Motivations", "Motives",
    "Motorcycles", "Motorists", "Motors", "Mountains", "Mouths",
    "Movements", "Moves", "Movies", "Muds", "Mums", "Murders", "Muscles",
    "Museums", "Music", "Musicals", "Musicians", "Mysteries", "Myths",
    "Nails", "Names", "Narratives", "Nationals", "Nations", "Natives",
    ...
    "Offences", "Offenders", "Offerings", "Offers", "Officers", "Offices",
    ...
    "Printers", "Printings", "Prints", "Priorities", "Prisoners", "Prisons",
    ...
    "Races", "Racings", "Racisms", "Racists", "Radars", "Radiations",
    "Radios", "Rages", "Raids", "Rails", "Railways", "Rains", "Rallies",
    "Ranges", "Rankings", "Ranks", "Rapes", "Rates", "Ratings", "Ratios",
    ...
    "Recoveries", "Recruitments", "Recruits", "Reds", "Reductions",
    "Referees", "References", "Referendums", "Reflections", "Reforms",
    "Refugees", "Refuges", "Refusals", "Regards", "Regimes", "Regions",
    ...
    "Series", "Servants", "Services", "Sessions", "Set-Ups", "Sets",
    "Settings", "Settlements", "Settlers", "Sexes", "Sexualities", "Shades",
    ...
    "Singles", "Sins", "Sirs", "Sisters", "Sites", "Situations", "Sizes",
    "Sketches", "Skies", "Skiings", "Skills", "Skins", "Skirts", "Skis",
    "Skulls", "Slaveries", "Slaves", "Sleeps", "Slices", "Slides",
    ...
    "Sorts", "Souls", "Sounds", "Soups", "Sources", "Souths",
    ...
    "Successors", "Sufferings", "Sugars", "Suggestions", "Suicides",
    ...
    "Syntheses", "Systems", "T-Shirts", "Tables", "Tablets", "Tackles",
    ...
    "Terms", "Terms", "Terrains", "Territories", "Terrorisms", "Terrorists",
    "Terrors", "Testimonies", "Testings", "Tests", "Textbooks", "Texts",
    ...
    "Tunes", "Tunnels", "Turnouts", "Turnovers", "Turns", "Tvs", "Twins",
    ...
    "Vessels", "Veterans", "Vices", "Victims", "Victories", "Videos",
    ...
    "Warrants", "Warriors", "Wars", "Washes", "Washings", "Wastes",
    "Watches", "Waters", "Waves", "Ways", "Weaknesses", "Wealths",
    "Weapons", "Weathers", "Webs", "Websites", "Weddings", "Wednesdays",
    "Weeds", "Weekends", "Weeks", "Weights", "Welcomes", "Welfares",
    "Well-Beings", "Wells", "Wests", "Wheat", "Wheels", "Whispers",
    "Whites", "Wholes", "Widows", "Widths", "Wildlives", "Willingnesses",
    ...
    "Yesterdays", "Yields", "Youngs", "Youngsters", "Youths", "Zones"
];
 ...
 */
const _VERB_ = [
    "Abandon", "Abolish", "Absorb", "Abuse", "Accelerate", "Accept",
    ...
    "Arrest", "Arrive", "Articulate", "Ask", "Aspire", "Assault",
    "Assemble", "Assert", "Assess", "Assign", "Assist", "Associate",
    "Assume", "Assure", "Attach", "Attack", "Attain", "Attempt", "Attend",
    ...
    "Bind", "Bite", "Blame", "Blast", "Bleed", "Blend", "Bless", "Block",
    "Blow", "Board", "Boast", "Boil", "Bomb", "Book", "Boost", "Border",
    "Born", "Borrow", "Bother", "Bounce", "Bow", "Brand", "Breach", "Break",
    ...
    "Die", "Differ", "Differentiate", "Dig", "Diminish", "Dip", "Direct",
    ...
    "Drive", "Drop", "Drown", "Dry", "Dub", "Dump", "Earn", "Ease", "Eat",
    ...
    "Handle", "Hang", "Happen", "Harm", "Harvest", "Hate", "Haunt", "Have",
    "Head", "Heal", "Hear", "Heat", "Heighten", "Help", "Hesitate", "Hide",
    "Highlight", "Hint", "Hire", "Hit", "Hold", "Honour", "Hook", "Hope",
    "Host", "House", "Hunt", "Hurry", "Hurt", "Identify", "Ignore",
    "Illustrate", "Imagine", "Impact", "Implement", "Imply", "Import",
    "Impose", "Impress", "Imprison", "Improve", "Include", "Incorporate",
    ...
    "Invite", "Invoke", "Involve", "Iron", "Isolate", "Issue", "Jail",
    "Join", "Joke", "Judge", "Jump", "Justify", "Keep", "Key", "Kick",
    "Kidnap", "Kill", "Kiss", "Knock", "Know", "Label", "Lack", "Land",
    ...
    "Modify", "Monitor", "Motivate", "Mount", "Move", "Multiply", "Murder",
    ...
    "Poison", "Pop", "Portray", "Pose", "Position", "Possess", "Post",
    ...
    "Rally", "Range", "Rank", "Rape", "Rate", "Reach", "React", "Read",
    ...
    "Substitute", "Succeed", "Suck", "Sue", "Suffer", "Suggest", "Suit",
    ...
    "Testify", "Text", "Thank", "Think", "Threaten", "Thrive", "Throw",
    "Tidy", "Tie", "Tighten", "Time", "Tip", "Title", "Tolerate", "Top",
    "Torture", "Toss", "Total", "Touch", "Tour", "Trace", "Track", "Trade",
    ...
    "Violate", "Visit", "Volunteer", "Vote", "Vow", "Wait", "Wake", "Walk",
...
const _ADVERB_ = [
    ...
    "Briefly", "Brightly", "Briskly", "Broadly", "Brutally", "By", "Calmly",
    "Carefully", "Casually", "Cautiously", "Certainly", "Cheap", "Clearly",
    ...
    "Currently", "Cynically", "Daily", "Dangerously", "Deep", "Deeply",
    "Definitely", "Deliberately", "Delicately", "Desperately",
    "Differently", "Direct", "Directly", "Discreetly", "Double", "Down",
    ...
    "Frighteningly", "Full-Time", "Fully", "Fundamentally", "Further",
    ...
    "Likewise", "Literally", "Little", "Live", "Long", "Long-Term", "Lot",
    "Loud", "Loudly", "Lovingly", "Low", "Loyally", "Magnificently",
    "Mainly", "Malevolently", "Maybe", "Meanwhile", "Merely", "Merrily",
    ...
    "NOT", "Notably", "Now", "Nowadays", "Nowhere", "O'Clock",
    ...
    "Usually", "Utterly", "Vanishingly", "Very", "Violently", "Warmly",
...
const _ADJECTIVE_ = [
    ...
    "Aesthetic", "Affordable", "Afraid", "Aged", "Aggressive",
    "Agricultural", "Alcoholic", "Alert", "Alien", "Alike", "Alive",
    ...
    "Appropriate", "Arbitrary", "Architectural", "Armed", "Artificial",
    ...
    "Broad", "Broken", "Brown", "Brutal", "Busy", "Calm", "Capable",
    ...
    "Correct", "Corresponding", "Corrupt", "Costly", "Countless", "Covered",
    "Crazy", "Cream", "Creative", "Credible", "Criminal", "Critical",
    "Crowded", "Crucial", "Crude", "Cruel", "Cult", "Cultural", "Curious",
    "Curly", "Current", "Curved", "Cute", "Cynical", "Daily", "Dairy",
    "Damaging", "Dangerous", "Dark", "Dead", "Deadly", "Dear", "Decent",
    ...
    "Dressed", "Driving", "Drunk", "Dry", "Dual", "Due", "Dull", "Dumb",
    ...
    "Female", "Feminist", "Few", "Fierce", "Final", "Financial", "Fine",
    ...
    "Frustrated", "Frustrating", "Full", "Full-Time", "Fun", "Functional",
    "Fundamental", "Funny", "Furious", "Further", "Future", "Gay",
    ...
    "Healthy", "Heavy", "Helpful", "Hidden", "High", "High-Profile",
    "Hilarious", "Historic", "Historical", "Hollow", "Holy", "Home",
    "Homeless", "Honest", "Hopeful", "Horrible", "Hostile", "Hot", "Huge",
    ...
    "Key", "Kind", "Large", "Large-Scale", "Late", "Later", "Latest",
    "Latter", "Lazy", "Leading", "Left", "Legal", "Legendary",
    "Legislative", "Legitimate", "Lengthy", "Lesbian", "Lesser", "Lethal",
    "Level", "Liable", "Liberal", "Lifelong", "Light", "Likely", "Limited",
    "Linear", "Liquid", "Literary", "Little", "Live", "Lively", "Living",
    "Local", "Located", "Logical", "Lonely", "Long", "Long-Standing",
    "Long-Term", "Long-Time", "Loose", "Lost", "Loud", "Lovely", "Low",
    "Loyal", "Lucky", "Luxury", "Mad", "Magic", "Magical", "Magnetic",
    "Magnificent", "Main", "Mainstream", "Major", "Male", "Mandatory",
    ...
    "Post-War", "Potential", "Powerful", "Practical", "Precious", "Precise",
    "Predictable", "Pregnant", "Preliminary", "Premier", "Prepared",
    ...
    "Quiet", "Racial", "Racist", "Radical", "Random", "Rapid", "Rare",
    ...
    "Safe", "Same", "Satisfied", "Scared", "Scary", "Scattered",
    "Sceptical", "Scientific", "Secondary", "Secret", "Secular", "Secure",
    "Selective", "Senior", "Sensible", "Sensitive", "Separate", "Serial",
    "Serious", "Severe", "Sexual", "Sexy", "Shallow", "Shaped", "Sharp",
    "Sheer", "Shiny", "Shocked", "Shocking", "Short", "Short-Term", "Shut",
    "Shy", "Sick", "Significant", "Silent", "Silly", "Silver", "Similar",
    "Simple", "Sincere", "Single", "Situated", "Ski", "Skilled", "Slight",
    "Slow", "Small", "Smart", "Smooth", "So-Called", "Social", "Socialist",
    "Soft", "Solar", "Sole", "Solid", "Solo", "Sophisticated", "Sorry",
    "Sound", "South", "Southern", "Spare", "Special", "Specialist",
    ...
    "Strict", "Striking", "Strong", "Structural", "Stunning", "Stupid",
    ...
    "Talented", "Tall", "Technical", "Technological", "Teenage",
    "Temporary", "Tender", "Terminal", "Terrible", "Terrific", "Theatrical",
    "Theoretical", "Thick", "Thin", "Thirsty", "Thorough",
    "Thought-Provoking", "Thoughtful", "Thrilled", "Tidy", "Tight",
    "Timely", "Tiny", "Tired", "Top", "Total", "Tough", "Toxic", "Toy",
    "Traditional", "Tragic", "Transparent", "Tremendous", "Tribal",
    "Tropical", "Troubled", "True", "Twin", "Typical", "Ugly", "Ultimate",
    "Unable", "Unacceptable", "Uncomfortable", "Unconscious", "Underground",
    "Underlying", "Unemployed", "Unexpected", "Unfair", "Unfortunate",
    "Unhappy", "Unique", "United", "Universal", "Unknown", "Unlikely",
    ...
    "Vicious", "Violent", "Virtual", "Visible", "Visual", "Vital", "Vocal",
